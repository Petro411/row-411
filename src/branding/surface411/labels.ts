export default {
    ...
    InternalServerError: "Intercal server error :(",
    SomethingWentWrong: "Something went wrong :(",

    // Auth Api Messages
    EmailPasswordReq: "Email and password is required.",
    UserNotRegisteredWithEmail: "User not registered with this email.",
    IncorrectCredentails: "Incorrect credentails.",
    ...
    Testimonials: [
        ...
        },
        {
            name: "Emily K.",
            rating: 5,
            review: "Secure, fast, and easy to use. Highly recommend Surface411 to anyone dealing with surface data.",
            image: "/assets/emily.png"
        },
    ],

    WithBrandName: "With Surface411",
    WithBrandDes: "Quickly find surface owners and property details—just enter your criteria and get results instantly with Surface411.",
...
SubscriptionPageDesc:"Choose the plan that best fits your needs.  Surface411 offers flexible pricing with access to accurate surface owner data to streamline your land acquisition process.",
