...
const AboutUs = ({ faqs }: Props) => {
  return (
    <>
      <SeoHead
        title="About Row411 | Mineral Owner Data for Landmen"
        description="Row411 is built by landmen, for landmen — delivering accurate, verified mineral owner contact data to power faster, smarter land acquisition."
        url="https://www.Row411.com/about"
        faqs={faqs}
      />
      <SiteHeader />
